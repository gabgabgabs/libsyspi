...
<body>
    ...
    <div class="page-wrapper default-theme sidebar-bg bg1 toggled">
        ...
        <div style="color:black;text-align:center;padding:100px;font;width:100%;height:100px;" class="col s12">
          <h1>ÚLTIMOS EMPRÉSTIMOS</h2>
        </div>
        <form method="POST" action="consulta-emprestimo.php">
        <div class="center">
    ...
    <?php
            ...
            $sql ="SELECT l.nome_livro, e.dt_retirada, e.dt_entrega, c.nome_cliente FROM livro as l INNER JOIN emprestimo as e on l.cod_livro = e.cod_emprestimo INNER JOIN cliente as c on c.cod_cliente WHERE nome_livro LIKE '%$pesquisar%' LIMIT 10";
            ...
            print"<td>".$rows->nome_livro."</td>";
                $data = $rows->dt_retirada;
                $divisor = explode("-", $data);
                $reverso = array_reverse($divisor);
                $data_final = implode("-", $reverso);
            print "\r\n";
            print "<td>".$data_final."</td>"; 
                $data2 = $rows->dt_entrega;
                $divisor2 = explode("-", $data2);
                $reverso2 = array_reverse($divisor2);
                $data_final2 = implode("-", $reverso2);
            print "\r\n";
            print "<td>".$data_final2."</td>";                         
      		print"</tr>";
            } 
            print"</table>";
            print"</div>";
