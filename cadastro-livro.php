...
<body>
  ...
  <form action="salvar-livro.php" method="post" style="margin-top: 20px">
  
  <div class="form-group">
    <input type="text" class="form-control" name="nome_livro" placeholder="Nome do livro"> 
  </div>
    <div class="form-group">
    <input type="text" class="form-control" name="autor_livro" placeholder="Autor(a)"> 
  </div>
    <div class="form-group">
    <input type="number"  class="form-control" name="quantidade_livro"  placeholder="Quantidade">
   </div>
    <div class="form-group">
    <input type="text" class="form-control" name="editora_livro" placeholder="Editora"> 
  </div>
      <div class="form-group">
    <input type="text" class="form-control" name="cod_usuario" placeholder="Usuario"> 
  </div>
